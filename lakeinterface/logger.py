...
# %% auto 0
__all__ = ['CONSOLE_LOG_HANDLER', 'CLOUDWATCH_LOG_HANDLER', 'LOG_HANDLERS', 'clear_all_handlers', 'add_stream_handler',
           'add_file_handler', 'add_cloudwatch_handler', 'configure_logger', 'predefined_logger', 'log']
