  ...
  'syms': { 'lakeinterface.athena': { 'lakeinterface.athena.Athena': ('athena.html#athena', 'lakeinterface/athena.py'),
            ...
            'lakeinterface.datalake': { 'lakeinterface.datalake.Datalake': ('s3.html#datalake', 'lakeinterface/datalake.py'),
                                        ...
                                        'lakeinterface.datalake.Datalake.most_recent': ( 's3.html#datalake.most_recent',
                                                                                         'lakeinterface/datalake.py'),
                                        'lakeinterface.datalake.Datalake.most_recent_folder': ( 's3.html#datalake.most_recent_folder',
                                                                                                'lakeinterface/datalake.py'),
                                        ...
                                        'lakeinterface.datalake.S3ObjectNotFound': ( 's3.html#s3objectnotfound',
                                                                                     'lakeinterface/datalake.py'),
                                        'lakeinterface.datalake.is_timestamp': ('s3.html#is_timestamp', 'lakeinterface/datalake.py'),
            ...
            'lakeinterface.logger': { 'lakeinterface.logger._boto_filter': ('logger.html#_boto_filter', 'lakeinterface/logger.py'),
                                      'lakeinterface.logger.add_cloudwatch_handler': ( 'logger.html#add_cloudwatch_handler',
                                                                                       'lakeinterface/logger.py'),
                                      'lakeinterface.logger.add_file_handler': ('logger.html#add_file_handler', 'lakeinterface/logger.py'),
                                      'lakeinterface.logger.add_stream_handler': ( 'logger.html#add_stream_handler',
                                                                                   'lakeinterface/logger.py'),
                                      'lakeinterface.logger.clear_all_handlers': ( 'logger.html#clear_all_handlers',
                                                                                   'lakeinterface/logger.py'),
                                      'lakeinterface.logger.configure_logger': ('logger.html#configure_logger', 'lakeinterface/logger.py'),
                                      'lakeinterface.logger.log': ('logger.html#log', 'lakeinterface/logger.py'),
                                      'lakeinterface.logger.predefined_logger': ( 'logger.html#predefined_logger',
                                                                                  'lakeinterface/logger.py')},
