...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'lakeinterface.athena': { 'lakeinterface.athena.Athena': ('athena.html#athena', 'lakeinterface/athena.py'),
                                      ...
                                      'lakeinterface.athena.LakeConfigNotFound': ( 'athena.html#lakeconfignotfound',
                                                                                   'lakeinterface/athena.py'),
                                      'lakeinterface.athena.get_data_catalog': ('athena.html#get_data_catalog', 'lakeinterface/athena.py'),
                                      ...
                                      'lakeinterface.athena.unzip': ('athena.html#unzip', 'lakeinterface/athena.py')},
            ...
            'lakeinterface.lake_utils': { 'lakeinterface.lake_utils.get_data_catalog': ( 'datalake.html#get_data_catalog',
                                                                                         'lakeinterface/lake_utils.py'),
                                          'lakeinterface.lake_utils.parse_column_info': ( 'datalake.html#parse_column_info',
                                                                                          'lakeinterface/lake_utils.py'),
                                          'lakeinterface.lake_utils.parse_table_info': ( 'datalake.html#parse_table_info',
                                                                                         'lakeinterface/lake_utils.py'),
            ...
            'lakeinterface.logger': { 'lakeinterface.logger.Logger': ('logger.html#logger', 'lakeinterface/logger.py'),
                                      'lakeinterface.logger.Logger.__init__': ('logger.html#logger.__init__', 'lakeinterface/logger.py'),
                                      ...
                                      'lakeinterface.logger.Logger.clear_all_handlers': ( 'logger.html#logger.clear_all_handlers',
                                                                                          'lakeinterface/logger.py'),
                                      'lakeinterface.logger.Logger.debug': ('logger.html#logger.debug', 'lakeinterface/logger.py'),
                                      'lakeinterface.logger.Logger.error': ('logger.html#logger.error', 'lakeinterface/logger.py'),
                                      'lakeinterface.logger.Logger.info': ('logger.html#logger.info', 'lakeinterface/logger.py'),
                                      'lakeinterface.logger.Logger.warning': ('logger.html#logger.warning', 'lakeinterface/logger.py'),
